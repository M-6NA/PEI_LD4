...
def warehouse_info_section():
    ...
    with tab10:
        ...
        st.markdown(
            f"""
            <div class="column1" style="background-color: #e9ecef; text-align: center; border-radius: 10px; padding: 0;">
                <div style="margin-bottom: -15px;"><h4 style = "color: black;">Cube utilization (%) | Round 6</h4></div>
            </div>
            """,
            unsafe_allow_html=True
        )
        ...
        with col1:
            plot_cube_util_gauge(6,'Raw materials warehouse')
        with col2:
            plot_cube_util_gauge(6,'Tank yard')
        with col3:
            plot_cube_util_gauge(6,'Finished goods warehouse')
...
def mixers_fillers_section():
    ...
    with col1:
        ...
        with tab9:
            plot_bottling_line_usage(6, 'AllFill 1')
