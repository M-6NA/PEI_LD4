...
def gross_margin_section():
    ...
    with col1:
        ...
        data_1 = {
            # 'Round': ['-2', '-1', '0', '1', '2', '3', '4'],
            # 'Total': [154869.9504, 160052.154, 160052.154, 151176.355, None, None, 155555.1963],
            # 'Quick_Pack': [None, None, 160776.1067, 149105.8207, None, None, 160776.1067],
            # 'WWP': [332034.7297, 308801.2769, 308801.2769, 290067.4128, None, None, 302040.815],
            # 'Poly': [None, None, 316087.8167, 291664.5286, None, None, 316087.8167],
            # 'Grande': [721543.1878, 737682.5616, 737682.5616, 689302.9083, 738763.4526, 682471.1905, 710178.4015],
            # 'Pure': [96580.2079, 87284.9423, 87284.9423, 85615.3402, None, None, 85615.3402], 
            # 'Vital': [55500.1878, 50446.2072, 50446.2072, 60391.3446, None, None, 60391.3446],
            # 'Domanga': [None, None, None, None, 4899.8155, 2432.6749, 4899.8155],
            # 'Mrs_Mango': [None, None, None, None, 100495.26, 83807.6832, 100495.26],
            # 'C_plus': [None, None, None, None, 951.6109, 173.4627, 951.6109],
            # 'CC_best': [None, None, None, None, 68941.7645, 58109.5643, 68941.7645],
            # 'Purchase_value': [1360528.264, 1344267.142, 1344267.142, 1276553.361, 1390915.827, 1267764.925, 1317523.398]

            'Round': ['-2', '-1', '0', '1', '2', '3', '4', '5', '6'],
            'Total': [154869.9504, 160052.154, 160052.154, 151176.355, None, None, 155555.1963, 152542.6481, 153698.5256],
            'Quick Pack': [None, None, None, None, 160776.1067, 149105.8207, None, None, None],
            'WWP': [332034.7297, 308801.2769, 308801.2769, 290067.4128, None, 302040.815, 291056.5687, 292802.4928, None],
            'Poly': [None, None, None, None, 316087.8167, 291664.5286, 4899.8391, 639935.8551, 640399.7157],
            'Grande': [721543.1878, 737682.5616, 737682.5616, 689302.9083, 738763.4526, 682471.1905, 710178.4015, 0, 0],
            'Pure': [96580.2079, 87284.9423, 87284.9423, 85615.3402, None, None, None, None, None],
            'Vital': [55500.1878, 50446.2072, 50446.2072, 60391.3446, None, None, None, None, None],
            'Domanga': [None, None, None, None, 4899.8155, 2432.6749, 9730.6999, 2432.6749, 2825.3973],
            'Mrs Mango': [None, None, None, None, 100495.26, 83807.6832, 77749.2965, 85886.3759, 86161.6422],
            'C plus': [None, None, None, None, 951.6109, 173.4627, 241.0858, 166.9929, 160.1954],
            'CC best': [None, None, None, None, 68941.7645, 58109.5643, 57128.0629, 54219.329, 54338.266],
            'Purchase value': [1360528.264, 1344267.142, 1344267.142, 1276553.361, 1390915.827, 1267764.925, 1317523.398, 1226240.445, 1230386.235]
    ...
    with col2:
        data_2 = {
            # 'Round': ['-2', '-1', '0', '1', '2', '3', '4'],
            # 'Bottling_lines_fixed_costs': [50000, 50000, 50000, 50000, 75000, 50000, 50000],
            # 'Permanent_employees': [300000, 300000, 300000, 300000, 560000, 400000, 300000],
            # 'Flexible_manpower': [87064.8116, 97585.1772, 97585.1772, 45219.4217, 26073.9423, 6707.1015, 95887.4172],
            # 'Outsourcing': [17285.624, 24675.5827, 24675.5827, 1478.8449, 3511.3416, 237.2543, 5253.276],
            # 'Mixer_fixed_costs': [31250, 31250, 31250, 31250, 31250, 31250, 31250],
            # 'Mixer_variable_costs': [187140.7594, 189888.0379, 189888.0379, 187777.5949, 236710.2531, 245055.7594, 251972.0886],
            # 'Production_costs': [672741.1951, 693398.7979, 693398.7979, 615725.8616, 932545.5372, 733250.1154, 734362.7819],
            # 'Cost_of_goods_sold': [2033269.459, 2037665.94, 2037665.94, 1892279.223, 2323461.364, 2001015.041, 2051886.179]
            'Round': ['-2', '-1', '0', '1', '2', '3', '4', '5', '6'],
            'Bottling lines fixed costs': [50000, 50000, 50000, 50000, 75000, 50000, 50000, 50000, 50000],
            'Permanent employees': [300000, 300000, 300000, 300000, 560000, 400000, 300000, 300000, 300000],
            'Flexible manpower': [87064.8116, 97585.1772, 97585.1772, 45219.4217, 26073.9423, 6707.1015, 95887.4172, 37913.539, 38493.1154],
            'Outsourcing': [17285.624, 24675.5827, 24675.5827, 1478.8449, 3511.3416, 237.2543, 5253.276, 1938.372, 1672.6385],
            'Mixer fixed costs': [31250, 31250, 31250, 31250, 31250, 31250, 31250, 31250, 31250],
            'Mixer variable costs': [187140.7594, 189888.0379, 189888.0379, 187777.5949, 236710.2531, 245055.7594, 251972.0886, 206045.886, 207304.7468],
            'Production costs': [672741.1951, 693398.7979, 693398.7979, 615725.8616, 932545.5372, 733250.1154, 734362.7819, 627147.7972, 628720.5008],
            'Cost of goods sold': [2033269.459, 2037665.94, 2037665.94, 1892279.223, 2323461.364, 2001015.041, 2051886.179, 1853388.242, 1859106.736]
        }
